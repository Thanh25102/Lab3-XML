...
public class OnSaleFragments extends Fragment {
    ...
    public static OnSaleFragments newInstance(String param1, String param2) {
        OnSaleFragments fragment = new OnSaleFragments();
